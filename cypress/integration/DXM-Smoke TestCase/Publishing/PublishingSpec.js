...
describe("Publishing should ", () => {
    ...
    it('Proceed to Folder, Branched Asset, Cloned Asset', () => {
        ...
        cy.wait(Constants.wait);
        cy.get('.ng-scope.ng-isolate-scope > .tree > .assetList > :nth-child(1) > .assetRow > .assetLabel > .assetLabelLink').trigger('dblclick');
        //cy.get('asset-browser.ng-star-inserted > .tree > .assetList > [style=""] > .assetRow > .assetLabel > .assetLabelLink').trigger('dblclick');
        cy.wait(Constants.wait);
        cy.get('.ng-scope.ng-isolate-scope > .tree > .assetList > :nth-child(2) > .assetRow > .assetLabel > .assetLabelLink').trigger('dblclick');
